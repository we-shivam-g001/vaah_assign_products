...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-customerproduct';
        ...
        */
        ...
        return view('customerproduct::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('customerproduct.name'),
            'version' => config('settings.global.customerproduct_version')??config('customerproduct.version'),
            'is_dev' => config('customerproduct.is_dev'),
        ];
